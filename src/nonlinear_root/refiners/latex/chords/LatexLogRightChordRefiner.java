...
public final class LatexLogRightChordRefiner extends RightChordRefiner implements LogRefiner {
    private final StringBuilder log = new StringBuilder( "" );

    public LatexLogRightChordRefiner(double a, double b, Function<Double, Double> fun) {
        super( a, b, fun );
